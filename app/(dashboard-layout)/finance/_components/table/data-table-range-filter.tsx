  ...
  return (
    ...
    >
      <Input
        ...
        min={min}
        max={max}
        className="h-8 w-full rounded border border-input bg-white text-black placeholder-muted-foreground dark:bg-slate-800 dark:text-slate-100 dark:placeholder-slate-400 dark:border-slate-700"
